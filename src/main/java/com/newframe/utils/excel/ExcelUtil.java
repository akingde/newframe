package com.newframe.utils.excel;
import jxl.Cell;
import jxl.Sheet;
import jxl.Workbook;
...
public class ExcelUtil<T> {
     ...
     * @param sheetName sheet页的名字，可为空
     * @param startIndex 起始行数
     * @return 返回数据
     */
    public List<T> importExcel( InputStream input,String sheetName,Integer startIndex) {
...
//                sheet.setColumnWidth(i, 256 * Integer.parseInt(attr.width()) + 184);
//            }
//            // 设置工作表的名称.
...
//                            //设置左对齐，居中和右对齐
//                            if (cellStyle != null) {
//                                if ("right".equals(attr.position())) {
//                                    // 水平方向的对齐方式
//                                    cellStyle.setAlignment(HSSFCellStyle.ALIGN_RIGHT);
//                                    cell.setCellStyle(cellStyle);
//                                } else if ("center".equals(attr.position())) {
//                                    // 水平方向的对齐方式
