...
public class TestCommonController extends BaseController {
    ...
    public JsonResult sendMessToAllByUid(Long uid, Integer roleId, String associatedOrderId, Long orderId, String messTitle, Integer messType, String messContent){
