 ...
 *
 */
package com.newframe.blockchain.algorithm.eddsa;
...
public class EdDSASecurityProvider extends Provider {
    ...
    protected void setup() {
        ...
        put("KeyFactory." + EdDSAKey.KEY_ALGORITHM, "com.newframe.blockchain.algorithm.eddsa.KeyFactory");
        put("KeyPairGenerator." + EdDSAKey.KEY_ALGORITHM, "com.newframe.blockchain.algorithm.eddsa.KeyPairGenerator");
        put("Signature." + EdDSAEngine.SIGNATURE_ALGORITHM, "com.newframe.blockchain.algorithm.eddsa.EdDSAEngine");
